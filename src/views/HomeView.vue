  ...
  <main class="container text-white">
    ...
    <input type="text" v-model="searchQuery" @input="getSearchResults" placeholder="Search for a city or state" class="py-2 px-1 w-full bg-transparent border-b focus:border-weather-secondary focus:outline-none focus:shadow-[0px_1px_0_0_#004E71]">    
      <ul class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]" v-if="mapboxSearchResults">
        ...
        No results matchs your query, try a different term.
        </p>  
        <template v-else>
...
const mapboxAPIKey = "pk.eyJ1IjoidHJpZ2dlcnh4MjM3IiwiYSI6ImNsOHc2ZGh2bjBsMmozd29naTR4ZDV3Zm4ifQ.rQNyqukNCSc1HhYnf_J2Ig"
